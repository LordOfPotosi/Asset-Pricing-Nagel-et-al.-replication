...
retex.dat <- cbind((fin.dat[,2:ncol(port.dat)]), fin.dat[,(ncol(port.dat)+1):ncol(fin.dat)]) # cbind((fin.dat[,2:ncol(port.dat)] - fin.dat$RF), fin.dat[,(ncol(port.dat)+1):ncol(fin.dat)]) ### Get excess returns 
