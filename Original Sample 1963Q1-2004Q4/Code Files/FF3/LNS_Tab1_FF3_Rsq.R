...
rsq.conf.int <- matrix(c(0.7,1.0),2,1)
...
rsq.conf.gls.int <- matrix(c(0.0,1.0),2,1)
...
rsq.conf.ind.int <- matrix(c(0.0,0.90),2,1)
...
rsq.conf.ind.gls.int <- matrix(c(0.0,0.70),2,1)
