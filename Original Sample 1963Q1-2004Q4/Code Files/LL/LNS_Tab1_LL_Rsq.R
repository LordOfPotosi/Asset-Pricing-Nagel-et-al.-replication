...
rsq.conf.int <- matrix(c(0.50,1.0),2,1)
...
rsq.conf.gls.int <- matrix(c(0.00,0.00),2,1)
...
rsq.conf.ind.int <- matrix(c(0.00,0.43),2,1)
...
rsq.conf.ind.gls.int <- matrix(c(0.00,0.80),2,1)#Not sure
